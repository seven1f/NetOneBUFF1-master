                                            ...
                                            <div class="row">
                                                <div class="col-sm-4">
                                                    <ul class="multi-column-dropdown">
                                                        <li><a href="product-m.html">爪子刀</a></li>
                                                        <li><a href="product-m.html">蝴蝶刀</a></li>
                                                        <li><a href="product-m.html">短剑</a></li>
                                                    </ul>
                                                </div>
                                                <div class="col-sm-4">
                                                    <ul class="multi-column-dropdown">
                                                        <li><a href="product-m.html">折叠刀</a></li>
                                                        <li><a href="product-m.html">熊刀</a></li>
                                                        <li><a href="product-m.html">弯刀</a></li>
                                                    </ul>
                                                </div>
                                                <div class="col-sm-4">
                                                    <ul class="multi-column-dropdown">
                                                        <li><a href="product-m.html">刺刀</a></li>
                                                        <li><a href="product-m.html">猎杀者匕首</a></li>
                                                        <li><a href="product-m.html">锯齿爪刀</a></li>
                                                    </ul>
                                                </div>
                                            </div>
                                        </ul>
...
<div class="product">
    <div class="container">
               ...
               <%-- <div class="col-lg-3 col-md-4 col-sm-6 home-grid">
                ...
                <c:forEach items="${goods}" var="g">
                    <div class="col-lg-3 col-md-4 col-sm-6 home-grid">
                        <div class="home-product-main">
                            <div class="home-product-top">
                                <a href="Single.do3?single=${g.goodsId}"><img src="${g.goodsImage}" alt="" class="img-responsive zoom-img"></a>
                            </div>
                            <div class="home-product-bottom">
                                <h3>${g.goodsType}</h3>
                                <p>${g.goodsName}</p>
        ...
        <div class="pager card-pager light-theme simple-pagination">
            <ul>
                <li class="disabled"><a href="showAll.do2?currentPage=<c:if test="${currentPage<=1}">1</c:if>${currentPage-1}" class="current prev">上一页</a></li>
                <li><a href="${pageContext.request.contextPath}/showAll.do2?currentPage=1" class="page-link">1</a></li>
                <li><a href="showAll.do2?currentPage=2" class="page-link">2</a></li>
                <li><a href="showAll.do2?currentPage=3" class="page-link">3</a></li>
                <li><a href="showAll.do2?currentPage=4" class="page-link">4</a></li>
                <li class="disabled"><span class="ellipse">…</span></li>
                <li><a href="#showAll.do2?currentPage=10" class="page-link">10</a></li>
                <li><a href="showAll.do2?currentPage=<c:if test="${currentPage}>=${pages}">${pages}</c:if>${currentPage+1}" class="current prev">下一页</a></li>
            </ul>
        </div>
    </div>
</div>
