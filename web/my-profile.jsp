                    ...
                    <nav class="navbar" role="navigation">
                        ...
                        <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
                            <ul class="nav navbar-nav">
                                ...
                                <li><a href="index.html">饰品市场</a></li>
                                <li><a href="index.html">库存估价</a></li>
                                <li><a href="index.html">游戏资讯</a></li>
                    ...
                    <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-2">
                        <ul class="nav navbar-nav">
                            <%
                                ...
                                if (user!=null){
                            %>
                            <li><a href="index.jsp">我的库存</a></li>
                            <li><a href="index.jsp">我的出售</a></li>
                            <li class="dropdown">
                                    ...
                                    <div class="row">
                                        <div class="col-sm-4">
                                            <ul class="multi-column-dropdown" style="width: 100px">
                                                <li><a href="product-m.html">个人信息</a></li>
                                                <li><a href="product-m.html">修改信息</a></li>
                                                <li><a href="product-m.html">修改密码</a></li>
                                                <li><a href="product-m.html">余额：<%=user.getUserBalance()%></a></li>
                                                <li><a href="product-m.html">充值</a></li>
                                                <li><a href="product-m.html">提现</a></li>
                                                <li><a href="product-m.html">注销</a></li>
                                            </ul>
                                        </div>
                                    </div>
                                </ul>
            ...
            <div class="agile-row">
                ...
                <div class="login-agileits-top">
                    <form action="login.do" method="post">
                        <input type="text" class="name" name="userId" Placeholder="Username" required=""/>
                        <input type="password" class="password" name="userPassword" Placeholder="Password" required=""/>
    ...
    <div class="l_Layout">
        <div class="hot_col1">
            <div class="sec-title" style="margin-left: 45px; width: 970px;">
                <span class="l_Right">
                    <a href="/market/?game=csgo#tab=selling" class="market-link" data-tab="selling">
                        进入市场
                    ...
                    <div class="product-main">
                        <div class="col-xs-12 product-block">
                            <div class="col-lg-3 col-md-4 col-sm-6 home-grid product-wid">
                                <div class="home-product-main">
                                    <div class="home-product-top">
                                        <a href="single.html"><img src="images/csgoimg/dao1.png" alt="" class="img-responsive zoom-img"></a>
                                    </div>
                            ...
                            <div class="col-lg-3 col-md-4 col-sm-6 home-grid product-wid">
                                <div class="home-product-main">
                                    <div class="home-product-top">
                                        <a href="single.html"><img src="images/csgoimg/buqiang1.png" alt="" class="img-responsive zoom-img"></a>
                                    </div>
                                    <div class="home-product-bottom">
                            ...
                            <div class="col-lg-3 col-md-4 col-sm-6 home-grid product-wid">
                                <div class="home-product-main">
                                    <div class="home-product-top">
                                        <a href="single.html"><img src="images/csgoimg/chongfeng1.png" alt="" class="img-responsive zoom-img"></a>
                                    </div>
                                    <div class="home-product-bottom">
                                        <h3><a href="single.html">冲锋枪</a></h3>
                                        <p>PP 野牛|(崭新出厂)</p>
                                    </div>
                                    <div class="srch">
                                        <span>$200</span>
                            ...
                            <div class="col-lg-3 col-md-4 col-sm-6 home-grid product-wid">
                                <div class="home-product-main">
                                    <div class="home-product-top">
                                        <a href="single.html"><img src="images/csgoimg/dao2.png" alt="" class="img-responsive zoom-img"></a>
                                    </div>
                                    <div class="home-product-bottom">
                                        <h3><a href="single.html">匕首</a></h3>
                                        <p>爪子刀|(崭新出厂)</p>
                            ...
                            <div class="col-lg-3 col-md-4 col-sm-6 home-grid product-wid">
                                <div class="home-product-main">
                                    <div class="home-product-top">
                                        <a href="single.html"><img src="images/csgoimg/chongfeng2.png" alt="" class="img-responsive zoom-img"></a>
                                    </div>
                                    <div class="home-product-bottom">
                                        <h3><a href="single.html">冲锋枪</a></h3>
                                        <p>UMP-45|(崭新出厂)</p>
                            ...
                            <div class="col-lg-3 col-md-4 col-sm-6 home-grid product-wid">
                                <div class="home-product-main">
                                    <div class="home-product-top">
                                        <a href="single.html"><img src="images/csgoimg/buqiang2.png" alt="" class="img-responsive zoom-img"></a>
                                    </div>
                                    <div class="home-product-bottom">
                                        <h3><a href="single.html">步枪</a></h3>
                                        <p>AK-47|(崭新出厂)</p>
                            ...
                            <div class="col-lg-3 col-md-4 col-sm-6 home-grid product-wid">
                                <div class="home-product-main">
                                    <div class="home-product-top">
                                        <a href="single.html"><img src="images/csgoimg/chongfeng3.png" alt="" class="img-responsive zoom-img"></a>
                                    </div>
                                    <div class="home-product-bottom">
                                        <h3><a href="single.html">冲锋枪</a></h3>
                                        <p>MP9|(崭新出厂)</p>
