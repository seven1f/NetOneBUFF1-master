        ...
        <div class="single-main">
            <div class="single-top-main">
                ...
                <div class="col-md-7 single-top-left simpleCart_shelfItem">
                    ...
                    <ul class="bann-btns">
                        <form method="post" action="drawup.do3?goodsId=<%=goods.goodsId%>">
                            <li><a href="#" class="item_add" style="margin-top: 15px;" id="goodsId" ><span>&nbsp&nbsp价格&nbsp&nbsp</span></a></li>>
                            <li><input type="text" id="price" name="price" class="item_add" style="width: 60px;height: 40px;"></li>>
                            <li><input type="submit" class="item_add" style="margin-top: 15px;font-size: 1em;
    color: #fff;
    padding: 0.83em 1.3em;
    background: #847057;
    display: block;
    text-align: center;
    font-family: 'Oswald', sans-serif;" value="上架"></li>>
                        </form>
                        </ul>
                </div>
                <div class="clearfix"> </div>
